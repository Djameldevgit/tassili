...
// Subcategorías de electromenager
  ...
  return (
    <div ref={containerRef} className="electromenager-slider-container">
      ...
      <style>{`
        ...
        /* SIN EFECTOS HOVER PARA PCs - IMPORTANTE */
...
export default SliderElectromenagers;