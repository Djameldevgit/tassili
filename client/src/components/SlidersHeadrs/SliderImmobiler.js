...
// Subcategorías de immobilier (operaciones + propiedades)
const immobilierData = [
  // Operaciones
  { id: 'vente', name: 'Vente', emoji: '💰', color: 'success' },
  { id: 'location', name: 'Location', emoji: '🏠', color: 'primary' },
  { id: 'location_vacances', name: 'Location Vacances', emoji: '🌴', color: 'warning' },
  { id: 'cherche_location', name: 'Cherche Location', emoji: '🔍', color: 'info' },
  { id: 'cherche_achat', name: 'Cherche Achat', emoji: '🏡', color: 'danger' },
