...
const Categories = ({ postData, handleChangeInput }) => {
  ...
  // Mapeo de categorías a emojis (solo emojis Unicode)
  ...
  const categories = [
    ...
    { id: 'vetements', name: t('vetements', 'Vêtements & Mode') },
    { id: 'alimentaires', name: t('Alimentaires', 'Alimentaires') },
    { id: 'sante_beaute', name: t('sante_beaute', 'Santé & Beauté') },
      ...
      <Form.Group>
        ...
        >
          ...
          {filteredCategories.map((category) => {
            ...
            // SOLUCIÓN: Concatenar emoji + texto como string simple
